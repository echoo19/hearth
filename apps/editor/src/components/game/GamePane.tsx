 ...
 *
 * Beyond that the pane has exactly two states — nothing yet, and running — and
 * one control, which belongs to the probe, not to the preview.
 */
    ...
    <div className="game-pane">
      {game.present && game.entry && projectPath ? (
        <div className="game-stage-wrap">
          <div ref={stageRef} className="game-stage" style={{ '--game-aspect': aspect } as React.CSSProperties}>
            <iframe
              ref={frameRef}
